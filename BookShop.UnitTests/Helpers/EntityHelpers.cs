...
{
    public static BookEntity CreateBook(int authorId, string title = "TestTitle", string description = "TestDescription", DateTime releaseDate = default) 
    {
        return BookEntity.Create(title, description, releaseDate, authorId);
    }
